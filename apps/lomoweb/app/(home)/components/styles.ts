...
export const ctaButton = tw(
	"bg-terracotta-9 hover:bg-terracotta-10 text-white border-2 border-black rounded-full px-8 py-3.5 min-h-11 font-display font-black text-base shadow-[0px_2px_8px_rgba(0,0,0,0.10)] hover:shadow-[0px_4px_12px_rgba(0,0,0,0.15)] active:shadow-[0px_1px_4px_rgba(0,0,0,0.10)] transition-shadow duration-150",
);
