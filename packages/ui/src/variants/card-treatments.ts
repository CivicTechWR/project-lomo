...
export const cardGhostColors: ColorMap = {
	terracotta: tw("bg-terracotta-2 data-hovered:bg-terracotta-3 data-pressed:bg-terracotta-4"),
	sage: tw("bg-sage-2 data-hovered:bg-sage-3 data-pressed:bg-sage-4"),
	yellow: tw("bg-yellow-2 data-hovered:bg-yellow-3 data-pressed:bg-yellow-4"),
	gray: tw("data-hovered:bg-gray-3 data-pressed:bg-gray-4"),
	red: tw("bg-red-2 data-hovered:bg-red-3 data-pressed:bg-red-4"),
	amber: tw("bg-amber-2 data-hovered:bg-amber-3 data-pressed:bg-amber-4"),
};
...
export const cardClassicColors: ColorMap = {
	terracotta: tw(
		"bg-terracotta-2 shadow-[var(--shadow-card-classic)]",
		"data-hovered:shadow-[var(--shadow-card-classic-hover)]",
		"data-pressed:shadow-[var(--shadow-card-classic-active)]",
	),
	sage: tw(
		"bg-sage-2 shadow-[var(--shadow-card-classic)]",
		"data-hovered:shadow-[var(--shadow-card-classic-hover)]",
		"data-pressed:shadow-[var(--shadow-card-classic-active)]",
	),
	yellow: tw(
		"bg-yellow-2 shadow-[var(--shadow-card-classic)]",
		"data-hovered:shadow-[var(--shadow-card-classic-hover)]",
		"data-pressed:shadow-[var(--shadow-card-classic-active)]",
	),
	gray: tw(
		"bg-gray-1 shadow-[var(--shadow-card-classic)]",
		"data-hovered:shadow-[var(--shadow-card-classic-hover)]",
		"data-pressed:shadow-[var(--shadow-card-classic-active)]",
	),
	red: tw(
		"bg-red-2 shadow-[var(--shadow-card-classic)]",
		"data-hovered:shadow-[var(--shadow-card-classic-hover)]",
		"data-pressed:shadow-[var(--shadow-card-classic-active)]",
	),
	amber: tw(
		"bg-amber-2 shadow-[var(--shadow-card-classic)]",
		"data-hovered:shadow-[var(--shadow-card-classic-hover)]",
		"data-pressed:shadow-[var(--shadow-card-classic-active)]",
	),
};
